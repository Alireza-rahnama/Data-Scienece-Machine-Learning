# -*- coding: utf-8 -*-
"""comprehensive_machine_learning_code_of_auto_price_prediction.ipynb

Automatically generated by Colaboratory. 

please find the jupyter notebook at:
    https://colab.research.google.com/drive/1eGktacMGbC4XetsL04qVZm9yUssv1BnM
"""
...
raw_data = pd.read_csv(r"C:\Users\shiraz computer\Desktop\my python programming projects\machine learning\real life examples\5(Final)\1.04._Real_life_example.csv")
...
# data.isnull() # shows a data frame with the information whether a data point is null (is missing value)
# Since True = the data point is missing, while False = the data point is not missing, we can sum them
# This will give us the total number of missing values feature-wise
#the reults indicate the number of mising datas in price and Engine V as shown below
data.isnull().sum()

# Let's simply drop all missing values
# This is not always recommended, however, when we remove less than 5% of the data, it is okay
#axis=0 indicates the rows of our data frame and axis  = 1 shows it's columns
...
# in this case as it is comprehended from the pdf above, the outliers lye in higher prices in our PDF so we will
## drop the 99th percentile of the data
...
# This plot looks kind of normal
...
# We won't be needing it, but 'drop=True' to completely forget about it
...
# we transform 'Price' with a log transformation
...
# check the scatters plots once again
...
# Since Year has the highest VIF, I will remove it from the model. 1<VIF<5 tottaly ok variables, above 10 is not acceptable!!
...
# it will define the variable as 1 and the rest of them as zero and repeats the process for every variable(categorical(non-numerical)feature)
...
# we declare a new variable that will contain the preferred order
